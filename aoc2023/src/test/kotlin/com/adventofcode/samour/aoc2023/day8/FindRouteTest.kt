...
class FindRouteTest {
    ...
    fun `Should return 2 steps for sample dataset`() {
        ...
        assertThat(result).isEqualTo("2".toBigInteger())
    }
    ...
    fun `Should return 6 steps for second sample dataset`() {
        ...
        assertThat(result).isEqualTo("6".toBigInteger())
    }
    ...
    fun `Should return 12643 steps for problem dataset`() {
        ...
        assertThat(result).isEqualTo("12643".toBigInteger())
    }
    ...
    @Test
    fun `Should return 13133452426987 steps for simultaneously navigating problem dataset`() {
        val result = findRoute("data.txt", true)

        assertThat(result).isEqualTo("13133452426987".toBigInteger())
    }
}
